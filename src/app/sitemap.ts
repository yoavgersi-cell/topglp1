...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/uk/mounjaro-nhs-eligibility`, lastModified, changeFrequency: "weekly", priority: 0.8 },
    { url: `${base}/uk/buying-glp1-safely`, lastModified, changeFrequency: "weekly", priority: 0.75 },
